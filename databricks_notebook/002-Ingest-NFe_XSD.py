...
#dbutils.fs.ls("file:/tmp/tax_lakehouse/")                 # Lista os arquivos do diretorio Temporario
# dbutils.fs.head("file:/tmp/tax_lakehouse/nfe.xml")       # leitura do conteudo inicial do arquivo

dbutils.fs.ls(f"dbfs:/user/luis_assuncao/tax_lakehouse/") # Lista os arquivos do Databricks File System
# dbutils.fs.head("dbfs:/user/luis_assuncao/tax_lakehouse/nfe.xml")
